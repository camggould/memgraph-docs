...
# memgraph-docs install script.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/camggould/memgraph-docs/main/install.sh | sh
#
# Override defaults via env vars:
#   MEMGRAPH_DOCS_VERSION       version tag to install (default: latest release, e.g. v0.1.0)
#   MEMGRAPH_DOCS_INSTALL_DIR   destination directory (default: /usr/local/bin, falling back to $HOME/.local/bin)

REPO="camggould/memgraph-docs"
BIN="memgraph-docs"
...
install_dir="${MEMGRAPH_DOCS_INSTALL_DIR:-}"
use_sudo=0
